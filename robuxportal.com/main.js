    ...
    var FOL = new CountUp('acc777', 0, parseInt(WANTED), 0, 18, options);
        FOL.start(function() {
          ...
          $("#CONS").fadeOut(1500, function() {
            $("#CONS").html("<strong class='reddd'>Complete 2 free sponsor offers</strong> Click <strong>Complete</strong> and follow instruction to receive your <strong>" + WANTED + "</strong> Robux for free...");
            $("#CONS").fadeIn(1500);
    ...
    $.ajax({
      ...
      success: function(data) {
          if (!data.includes("FLICKERROR")) {
			...
			$(".robfriends").html("<strong>" + JSXD.friends + "</strong> Friends  ");
			$(".robfollowers").html("<strong>" + JSXD.followers + "</strong> Followers  ");
			$(".robfollowing").html("<strong>" + JSXD.followings + "</strong> Followings  ");
